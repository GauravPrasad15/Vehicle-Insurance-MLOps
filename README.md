...
Welcome to this MLOps project, designed to demonstrate a robust pipeline for managing vehicle insurance prediction. This project aims to display the complete MLOps pipeline using various tools, techniques, services, and features that go into building and deploying a machine learning pipeline for real-world data management. Follow on to understand project setup, data processing, model deployment, and CI/CD automation!
...
- Set MongoDB URL:
  Using `.env` environmental variable for the setup
...
- Create an S3 bucket named `my-model-vehicle-mlops` in the `us-east-1` region.
