...
async def predictRouteClient(request: Request):
    ...
    try:
        ...
        # Interpret the prediction result as 'Insurance Applicable' or 'Insurance not Applicable'
        status = "Insurance Applicable" if value == 1 else "Insurance not Applicable"
